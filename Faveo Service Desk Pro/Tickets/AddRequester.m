...
//    self.headerTitleView.backgroundColor= [UIColor colorFromHexString:@"F9E9E6"];
...
- (IBAction)submitButtonAction:(id)sender {
    ...
    if(self.emailTextField.text.length==0 && self.firstNameTextField.text.length==0 && _lastNameTextField.text.length==0)
    {
    ...
    } else if (self.emailTextField.text.length<2) {
    ...
    }else if (self.firstNameTextField.text.length==0 && self.lastNameTextField.text.length==0 ){
...
-(void)addRequesterMethod{
    if ([[Reachability reachabilityForInternetConnection]currentReachabilityStatus]==NotReachable)
    {
       ...
       [SVProgressHUD showWithStatus:@"Please wait"];
        ...
        @try{
            NSString *url =[NSString stringWithFormat:@"%@helpdesk/register?token=%@&first_name=%@&last_name=%@&email=%@&mobile=%@&code=%@",[userDefaults objectForKey:@"companyURL"],[userDefaults objectForKey:@"token"],_firstNameTextField.text,_lastNameTextField.text,_emailTextField.text,_mobileTextField.text,_codeTextField.text];
                ...
                if (json) {
                        ...
                        
                    {
                        ...
                        dispatch_async(dispatch_get_main_queue(), ^{
                            ...
                            self->globalVariables.emailFromAddRequester=self->_emailTextField.text;
                            self->globalVariables.firstNameFromAddRequester=self->_firstNameTextField.text;
                            self-> globalVariables.lastNameFromAddRequester=self->_lastNameTextField.text;
                            self->globalVariables.mobileNubmberFromAddRequster=self->_mobileTextField.text;
                            self->globalVariables.mobileCodeFromAddRequester=self->_codeTextField.text;
                            
                            
                            CreateTicketView *create=[self.storyboard instantiateViewControllerWithIdentifier:@"CreateTicketViewId"];
