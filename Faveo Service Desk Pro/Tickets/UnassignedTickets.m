...
-(void)tapDetected{
    ...
    @finally
    {
        NSLog( @" I am in clickedOnAssignButton method in Unassigned Tickets ViewController" );
...
-(void)MergeButtonClicked
{
    ...
    @finally
    {
        NSLog( @" I am in mergeButtonCicked method in Unassigned Tickets ViewController" );
        ...
        @try{
            ...
            [webservices httpResponseGET:url parameter:@"" callbackHandler:^(NSError *error,id json,NSString* msg) {
                ...
                if (json) {
                 ...
                 //   NSLog(@"Thread-getUnassignedTickets--%@",json);
    ...
    if ([[Reachability reachabilityForInternetConnection]currentReachabilityStatus]==NotReachable)
    {
        ...
        @try{
            ...
            [webservices getNextPageURLUnassigned:_path1 pageNo:Page  callbackHandler:^(NSError *error,id json,NSString* msg) {
                ...
                NSLog(@"Thread-NO5-unassigned-closed");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == [_mutableArray count]) {
        ...
        @finally
        {
            NSLog( @" I am in cellForRowAtIndexPath method in Unassigned Tickets ViewController" );
...
-(void)addUIRefresh{
    ...
    refresh.backgroundColor = [UIColor colorFromHexString:@"049BE5"];
                ...
                if (json) {
                    ...
                    if([[json objectForKey:@"message"] isKindOfClass:[NSArray class]])
                    {
                        ...
                        if([msg hasPrefix:@"Status changed"]){
                            ...
                            UnassignedTickets *vc=[self.storyboard instantiateViewControllerWithIdentifier:@"unAssignedId"];
                            [self.navigationController pushViewController:vc animated:YES];
                        }else
                        {
