...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ClientDetailsViewController *clientDetail=[self.storyboard instantiateViewControllerWithIdentifier:@"clientDetailsViewId"];
    ...
    @try{
        ...
        if([sen isEqualToString:@"tickets"])
        {
            ...
            globalVariables.ticketId= [finaldic objectForKey:@"row_id"];
            ...
            if(( ![[finaldic objectForKey:@"requester"] isEqual:[NSNull null]] ) )
            {
                globalVariables.firstNameFromTicket=  [profileDict objectForKey:@"changed_by_first_name"];
                globalVariables.lastNameFromTicket= [profileDict objectForKey:@"changed_by_last_name"];
            ...
            globalVariables.userIDFromUserList=[profileDict objectForKey:@"id"];
            globalVariables.First_nameFromUserList=  [profileDict objectForKey:@"changed_by_first_name"];
            globalVariables.Last_nameFromUserList= [profileDict objectForKey:@"changed_by_last_name"];
            
            globalVariables.userImageFromUserList= [profileDict objectForKey:@"profile_pic"];
            globalVariables.emailFromUserList= [profileDict objectForKey:@"email"];
            globalVariables.mobilecodeFromUserList=@"";
            globalVariables.phoneNumberFromUserList=@"Not Available";
          //  globalVariables.userIDFromUserList=@"";
            globalVariables.mobileNumberFromUserList=@"";
            globalVariables.userNameFromUserList=[profileDict objectForKey:@"changed_by_user_name"];
            globalVariables.userRoleFromUserList=@"user";
